    ...
    public DataList getDataListById(int dataId) throws Exception {
        ...
        try {
            ...
            if (c != null) {
                ...
                rs = ps.executeQuery();
                if (rs.next()) {
                    listData.setId(rs.getInt("ID"));
                    listData.setName(rs.getString("PRODUCT_NAME"));
                    listData.setNumber(rs.getString("PRODUCT_NUMBER"));
                    listData.setLink(rs.getString("PRODUCT_LINK"));
                    listData.setHesabDate(rs.getDate("INSERT_DATE"));
                    listData.setPrice(rs.getFloat("amazone"));
                    listData.setPrice2(rs.getFloat("uae.microless"));
                    listData.setPrice3(rs.getFloat("mygsm"));
                } else {
                    listData = null;
                }
            } else {
